...
extension ExploreTableViewCell{
    ...
    func configureCell(_ petsHotel : PetHotels) {
        self.exploreCard = ExploreCard(petHotelName: "test", distance: "x", supportedPet: [PetSupported(petType: "Anjing", size: "M")], lowestPrice: 15, displayImage: "test")
        self.exploreCard.translatesAutoresizingMaskIntoConstraints = false
        self.exploreCard.backgroundColor = UIColor(named: "white")
    }
}
