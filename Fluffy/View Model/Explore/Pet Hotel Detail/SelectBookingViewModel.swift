...
class SelectBookingViewModel {
    ...
    func getAllPet() {
        ...
        petArray?.subscribe(onNext: { (value) in
            ...
            for pet in value {
                petModel.append(OrderDetailBody(petName: pet.petName!, petType: pet.petType!, petSize: pet.petSize!, petData: pet.petData!,packageID: -1, orderDetailPrice: 0, isExpanded: false, customSOP: [CustomSopBody]()))
            }
